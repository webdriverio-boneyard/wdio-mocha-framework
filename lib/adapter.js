...
adapter.run = function(cid, config, specs, capabilities) {
    ...
    mocha.suite.on('pre-require', () => INTERFACES[config.mochaOpts.ui].forEach(DONOTHING/* runInFiberContext.bind(null, config.mochaOpts.ui) */))
    ...
    return new Promise((resolve, reject) => {
        ...
        Object.keys(EVENTS).forEach((e) => runner.on(e, (payload, err) => {
            let error
