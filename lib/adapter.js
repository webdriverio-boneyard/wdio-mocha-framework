...
class MochaAdapter {
    ...
    async run () {
        ...
        wrapCommands(global.browser, {
            beforeCommand: this.config.beforeCommand,
            afterCommand: this.config.afterCommand,
            onCommandException: this.config.onCommandException
        })
